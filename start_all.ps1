...
try {
    ...
    Start-Process -FilePath powershell -ArgumentList '-NoExit','-Command',"cd '$root\\backend'; . .venv\\Scripts\\Activate.ps1; uvicorn app.main:app --port 8000" -WindowStyle Normal
